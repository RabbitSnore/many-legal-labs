...
source("./scripts/simulate/darley_simulation.R", local = knitr::knit_global()) # REPLACE WITH DATA IMPORTATION
source("./scripts/wrangle/darley_prelim.R", local = knitr::knit_global())
source("./scripts/calculate/darley_core.R", local = knitr::knit_global())
source("./scripts/analyze/darley_analysis.R", local = knitr::knit_global())
